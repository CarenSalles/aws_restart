...
#  Para contar hasta 10, escriba el siguiente código.
#Python utiliza la sangría para determinar que la instrucción print está dentro de la instrucción del bucle for:
